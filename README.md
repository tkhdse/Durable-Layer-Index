...
Following this, download Ollama from the following [link](https://ollama.com/download). After downloading, run the following commands to get the llama3 model running locally:
